...
void main() {
  ...
  String arrayContent = content.substring(firstArrayOpenBracket + 1, firstArrayCloseBracket);
  ...
  if (cols.length != 7) {
    print("Found " + cols.length.toString() + " columns, expected 7. Parts found: " + rawParts.length.toString());
    return;
  }
  ...
  String newContent = content.substring(0, startIdx) + newChildren + content.substring(secondArrayCloseBracket + 1);
